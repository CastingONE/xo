// Code generated by 'yaegi extract github.com/CastingONE/xo/types'. DO NOT EDIT.

package internal

import (
	"github.com/CastingONE/xo/types"
	"reflect"
)

func init() {
	Symbols["github.com/CastingONE/xo/types/types"] = map[string]reflect.Value{
