// Code generated by 'yaegi extract github.com/amksd/xo/types'. DO NOT EDIT.

package internal

import (
	"github.com/amksd/xo/types"
	"reflect"
)

func init() {
	Symbols["github.com/amksd/xo/types/types"] = map[string]reflect.Value{
