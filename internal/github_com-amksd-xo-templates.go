// Code generated by 'yaegi extract github.com/CastingONE/xo/templates'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/CastingONE/xo/templates/templates"] = map[string]reflect.Value{
