// Code generated by 'yaegi extract github.com/amksd/xo/models'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/amksd/xo/models/models"] = map[string]reflect.Value{
		...
		"_DB": reflect.ValueOf((*_github_com_amksd_xo_models_DB)(nil)),
	}
}

// _github_com_amksd_xo_models_DB is an interface wrapper for DB type
type _github_com_amksd_xo_models_DB struct {
	IValue           interface{}
...
func (W _github_com_amksd_xo_models_DB) ExecContext(a0 context.Context, a1 string, a2 ...interface{}) (sql.Result, error) {
	return W.WExecContext(a0, a1, a2...)
}
func (W _github_com_amksd_xo_models_DB) QueryContext(a0 context.Context, a1 string, a2 ...interface{}) (*sql.Rows, error) {
	return W.WQueryContext(a0, a1, a2...)
}
func (W _github_com_amksd_xo_models_DB) QueryRowContext(a0 context.Context, a1 string, a2 ...interface{}) *sql.Row {
